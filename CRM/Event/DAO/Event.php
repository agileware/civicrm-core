 ...
 * (GenCodeChecksum:666de44eb94b4fe9678966e537deebed)
 */
...
class CRM_Event_DAO_Event extends CRM_Core_DAO {
  ...
  /**
   * Event's native time zone as an offset
   *
   * @var text
   */
  public $event_tz_offset;
  ...
  public static function &fields() {
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'event_tz' => [
          'name' => 'event_tz_offset',
          'type' => CRM_Utils_Type::T_TEXT,
          'title' => ts('Event Time Zone'),
          'description' => ts('Event\'s native time zone as an offset'),
          'import' => FALSE,
          'where' => 'civicrm_event.event_tz_offset',
          'export' => FALSE,
          'default' => 'NULL',
          'table_name' => 'civicrm_event',
          'entity' => 'Event',
